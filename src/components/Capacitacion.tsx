...
export default function Capacitacion() {
    return (
        ...
        >
            ...
            />
            <div className="absolute inset-0" style={{ background: `rgb(36,63,115,0.9)` }} />
                    ...
                    <div className="flex flex-wrap gap-2 mb-10">
                        {tagsData.map((tag) => (
                            <span
                                ...
                                style={{ background: `rgba(255,255,255,0.12)`, border: `1px solid rgba(255,255,255,0.18)`, color: `#96BDD8` }}
                            >
                                {tag}
                            </span>
                        ))}
