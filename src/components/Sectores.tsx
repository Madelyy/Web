                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {sectoresData.map((s) => (
                        <div
                            ...
                            style={{ height: `280px`, background: `#111827` }}
                        >
                            <img src={SECTOR_IMAGES[s.title]} alt={s.title} className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-108"
                            />
                            <div
                                className="absolute inset-0 transition-opacity duration-300  hover:opacity-80"
                                style={{ background: `linear-gradient(to top, rgba(20,30,50,0.89) 0%, rgba(20,30,50,0.30) 60%, transparent 100%)` }}
                            >
